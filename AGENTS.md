...
internal/
  ...
  executor/              # PTY-backed SSH automation and local/remote session recording
...
- Automated Linux and network-device commands use PTY interactive sessions so logs retain the real terminal transcript
